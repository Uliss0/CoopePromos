                  ...
                  <div key={point.key}>
                    ...
                    >
                      <span className="tree">
                        <img
                          src={descuento}
                          className=" max-w-[30px] min-h-[30px] max-h-[30px]"
                          alt="logo"
                        />
                      </span>
                      {openMarkers[point.key] && (
                        ...
                        >
                          <p className="text-lg">
                            <strong>{point.nomComercio}</strong>
                          </p>
                          <p>
                            Direccion: <strong>{point.direccion}</strong>
                          </p>
                          <p>
                            Telefono:
                            <strong>
                              {point.prefijo}-{point.telefono}
                            </strong>
                          </p>
                          <p>
                            Descuento:<strong>{point.dto}%</strong>
                          </p>
                        </InfoWindow>
                      )}
                    </AdvancedMarker>
